...
public class KeyConfig {
	...
	public void Initialize() {
		...
		keyTable.Add (ConfigurableKeyType.M, new ConfigurableKey (new KeyCode[] { KeyCode.M }));
		keyTable.Add (ConfigurableKeyType.Esc, new ConfigurableKey (new KeyCode[] { KeyCode.Escape }));
	}
